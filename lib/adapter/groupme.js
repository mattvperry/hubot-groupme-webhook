    ...
    (0, _createClass3.default)(GroupMeAdapter, [{
        ...
        value: function run() {
            return __awaiter(this, void 0, _promise2.default, _regenerator2.default.mark(function _callee() {
                ...
                }, _callee, this, [[1, 31], [12, 16, 20, 28], [21,, 23, 27]]);
            }));
        }
    }, {
        key: "send",
                ...
                return _regenerator2.default.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                return _context3.abrupt("return", this.send.apply(this, [envelope, "@" + envelope.user.name + " " + strings[0]].concat((0, _toConsumableArray3.default)(strings.slice(1)))));
                ...
                return _regenerator2.default.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                return _context4.abrupt("return", this.send(envelope, "/topic " + strings[0]));
